          ...
          <div className="space-y-6 text-gray-600 leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                <a href="mailto:kontakt@hometria.pl" className="text-[#FF1493] hover:underline">kontakt@hometria.pl</a>{' '}
                lub telefonicznie: <a href="tel:+48889000829" className="text-[#FF1493] hover:underline">+48 889 000 829</a>.
              </p>
            </section>
