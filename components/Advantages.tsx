          ...
          {advantages.map((item, idx) => {
            ...
            return (
              <ScrollReveal key={item.title} delay={0.1 * idx}>
                <div
                  className="group relative h-full p-7 rounded-2xl border border-white/5 bg-white/3 hover:border-[#E6007E]/40 hover:bg-white/6 transition-all duration-300 overflow-hidden"
                >
