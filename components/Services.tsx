        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.title}
                className="group flex flex-col items-center text-center p-6 rounded-2xl border border-gray-100 bg-gray-50/50 hover:border-[#E6007E]/30 hover:bg-pink-50/30 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-default"
              >
